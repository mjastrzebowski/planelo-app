...
//           let placeId = (item.place === '-KBHukjV0l8M-EkpTdI4' ? 1 : 2);
//           let clientId = this.clientStore.getItemByKey(item.client).id;
//           let trainerId = this.trainerStore.getItemByKey(item.trainer).id;

//           if (i >= 5000 && i < 7500) {
//             this.workoutService.post({
//               "clientId": clientId,
//               "trainerId": trainerId,
//               "date": item.date,
